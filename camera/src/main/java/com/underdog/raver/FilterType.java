...
import com.underdog.gpuv.egl.filter.GlBilateralFilter;
import com.underdog.gpuv.egl.filter.GlBoxBlurFilter;
import com.underdog.gpuv.egl.filter.GlBrightnessFilter;
import com.underdog.gpuv.egl.filter.GlBulgeDistortionFilter;
import com.underdog.gpuv.egl.filter.GlCGAColorspaceFilter;
import com.underdog.gpuv.egl.filter.GlContrastFilter;
import com.underdog.gpuv.egl.filter.GlCrosshatchFilter;
import com.underdog.gpuv.egl.filter.GlExposureFilter;
import com.underdog.gpuv.egl.filter.GlFilter;
import com.underdog.gpuv.egl.filter.GlFilterGroup;
import com.underdog.gpuv.egl.filter.GlGammaFilter;
import com.underdog.gpuv.egl.filter.GlGaussianBlurFilter;
import com.underdog.gpuv.egl.filter.GlGrayScaleFilter;
import com.underdog.gpuv.egl.filter.GlHalftoneFilter;
import com.underdog.gpuv.egl.filter.GlHazeFilter;
import com.underdog.gpuv.egl.filter.GlHighlightShadowFilter;
import com.underdog.gpuv.egl.filter.GlHueFilter;
import com.underdog.gpuv.egl.filter.GlInvertFilter;
import com.underdog.gpuv.egl.filter.GlLookUpTableFilter;
import com.underdog.gpuv.egl.filter.GlLuminanceFilter;
import com.underdog.gpuv.egl.filter.GlLuminanceThresholdFilter;
import com.underdog.gpuv.egl.filter.GlMonochromeFilter;
import com.underdog.gpuv.egl.filter.GlOpacityFilter;
import com.underdog.gpuv.egl.filter.GlPixelationFilter;
import com.underdog.gpuv.egl.filter.GlPosterizeFilter;
import com.underdog.gpuv.egl.filter.GlRGBFilter;
import com.underdog.gpuv.egl.filter.GlSaturationFilter;
import com.underdog.gpuv.egl.filter.GlSepiaFilter;
import com.underdog.gpuv.egl.filter.GlSharpenFilter;
import com.underdog.gpuv.egl.filter.GlSolarizeFilter;
import com.underdog.gpuv.egl.filter.GlSphereRefractionFilter;
import com.underdog.gpuv.egl.filter.GlSwirlFilter;
import com.underdog.gpuv.egl.filter.GlToneCurveFilter;
import com.underdog.gpuv.egl.filter.GlToneFilter;
import com.underdog.gpuv.egl.filter.GlVibranceFilter;
import com.underdog.gpuv.egl.filter.GlVignetteFilter;
import com.underdog.gpuv.egl.filter.GlWatermarkFilter;
import com.underdog.gpuv.egl.filter.GlWeakPixelInclusionFilter;
import com.underdog.gpuv.egl.filter.GlWhiteBalanceFilter;
import com.underdog.gpuv.egl.filter.GlZoomBlurFilter;
import com.underdog.raver.filter.GlBitmapOverlaySample;
